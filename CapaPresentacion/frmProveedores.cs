    ...
    public partial class frmProveedores : Form
    {
        ...
        private void iconButton3_Click(object sender, EventArgs e)
        {
            ...
            Proveedor obj = new Proveedor()
            {
                ...
                RazonSocial = txtrazonsociall.Text,
            ...
            if (obj.IdProveedor == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    ...
                    dgvdata.Rows.Add(new object[] {"",idgenerado,txtdocumento.Text,txtrazonsociall.Text,txtcorreo.Text,txttelefono.Text,
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["RazonSocial"].Value = txtrazonsociall.Text;
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtrazonsociall.Text = dgvdata.Rows[indice].Cells["RazonSocial"].Value.ToString();
